...
The inference graph contains one of four input nodes depending on the user
specified option.
...
The following output nodes are typically returned by the model.postprocess(..):
...
The actual output nodes are model dependant.
